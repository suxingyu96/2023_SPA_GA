...
class DataReader:
    ...
    def __generate_stu_list(self):
        logger.info('Reading students\' data from the given path: ', self.__stu_list_path)
    ...
    def __generate_supervisor_list(self):
        logger.info('Reading supervisors\' data from the given path: ', self.__sup_list_path)
    ...
    def __generate_project_list(self):
        logger.info('Reading projects\' data from the given path: ', self.__proj_list_path)
    ...
    def __student_constraints_check(self, stu: Student, proj_list: list[Project]):
        preference_list = stu.projectList
        sup_set = set()
